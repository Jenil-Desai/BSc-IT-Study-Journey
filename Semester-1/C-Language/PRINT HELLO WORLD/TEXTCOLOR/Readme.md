...
The program prints hello world in colorfull way with the help of C-Language.
...
This program prints the hello world in all possible colors c language has using for loop.
